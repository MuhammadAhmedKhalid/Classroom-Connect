...
namespace Classroom.DataAccess.Migrations
{
    ...
    [Migration("20250515173846_addAnnouncementsTableToDb")]
    partial class addAnnouncementsTableToDb
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Classroom.Models.Announcement", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Classroom.Models.AssignmentSubmission", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Classroom.Models.ClassMember", b =>
                {
                    b.Property<int>("ClassMemberId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("ClassMemberId"));
            ...
            modelBuilder.Entity("Classroom.Models.AssignmentSubmission", b =>
                {
                    ...
                    b.HasOne("Classroom.Models.ApplicationUser", "User")
                        .WithMany()
